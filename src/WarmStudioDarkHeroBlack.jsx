...
const Hero = ({ theme }) => {
  ...
  return (
    <section ref={container} className="relative min-h-[100dvh] w-full overflow-hidden bg-[var(--color-base)] flex flex-col items-center justify-center pt-32 pb-12 border-b border-[var(--color-border)]">
      {/* Background Effects */}
      <div className="absolute inset-0 z-0 bg-[radial-gradient(ellipse_at_top,var(--color-surface)_0%,transparent_80%)]"></div>
...
export default function WarmStudioDarkHeroBlack({ theme = 'warm-dark-hero-black' }) {
  return (
